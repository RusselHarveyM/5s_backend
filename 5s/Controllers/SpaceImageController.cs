...
namespace _5s.Controllers
{
    ...
    public class SpaceImageController : ControllerBase
    {
        ...
        public async Task<IActionResult> UploadSpaceImage(int spaceId, IFormFile file)
        {
            try
            {
        ...
        [HttpGet]
        [Route("get/{spaceId}")]
        public async Task<IActionResult> GetSpaceImages(int spaceId)
        {
            try
            {
        ...
        public async Task<IActionResult> DeleteSpaceImage(int imageId)
        {
            try
            {
